...
public class SDAveragedConditionedGradientCalculationAlgorithm extends AbstractCommonCalculationAlgorithm implements CalculationAlgorithm, TissueObserverAlgorithm{
	public static final String Y_AXIS_BIN_SIZE_IN_MIKRON = "y axis bin size in mikron";
	
	private Map<Long, TissueObserver> observers;
	public  SDAveragedConditionedGradientCalculationAlgorithm(){
	...
	public CalculationAlgorithmDescriptor getCalculationAlgorithmDescriptor(int id) {
	   ...
	   return new CalculationAlgorithmDescriptor(){
	   	...
	   	public String getDescription() {	         
			...
			public String getName() { return "SD of Averaged Conditioned Gradient Calculator"; }
		...
		try{
			...
			for(double i = 0; i < arraySize; i++){
				if(numberOfCellsInBin[(int)i] > 1){
					...
					ArrayList<Double> indVals = individualResults.get((int)i);
					double sum = 0;
