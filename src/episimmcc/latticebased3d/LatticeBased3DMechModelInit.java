...
public class LatticeBased3DMechModelInit extends BiomechanicalModelInitializer {
	private LatticeBased3DModelGP globalParameters;
	public LatticeBased3DMechModelInit(){
		super();
	...
	public LatticeBased3DMechModelInit(SimulationStateData simulationStateData){
