...
public abstract class ResultSetManager {
	...
	public static void copyResultSetToDataManager(ResultSet<? extends Number> results,  CalculationDataManager<? extends Number> dataManager, CalculationAlgorithmType type){
