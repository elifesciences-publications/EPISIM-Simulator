...
class JarClassLoader extends URLClassLoader {
    ...
    public String getMainClassName() throws IOException {
        return getClassName(Attributes.Name.MAIN_CLASS);
    }
    
    public Class getMainModelClass() throws IOException, ClassNotFoundException {
   	 System.out.println(getClassName(new Attributes.Name("Main-Model-Class")));
        
         return loadClass(getClassName(new Attributes.Name("Main-Model-Class")));
