...
import episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC;
   ...
   public InteractionResult calculateRepulsiveAdhesiveAndChemotacticForces(Bag neighbours, Double3D thisloc, boolean finalSimStep)
   {
       ...
       for(int i=0;i<neighbours.numObjs;i++)
       {
          ...
          {   	 
             ...
             if(this.modelConnector instanceof episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC && finalSimStep){
          		...
          		//			dy, thisSemiAxisA, thisSemiAxisB, thisSemiAxisB, otherSemiAxisA, otherSemiAxisB,otherSemiAxisC, d_membrane_this, d_membrane_other, actDist, optDist);
          			...
          			((episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC)this.modelConnector).setContactArea(other.getID(), Math.abs(contactAreaCorrect));
       ...
       if(dummyCellsAdded){
        ...
        if(this.modelConnector instanceof episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC && finalSimStep){
      	 ((episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC)this.modelConnector).setTotalContactArea(totalContactArea);
   ...
   private Point3d findReferencePositionOnBoundary(Point3d cellPosition){
	...
	public void calculateSimStep(boolean finalSimStep){
		if(finalSimStep){
			...
			if(modelConnector instanceof episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC){				
		  		 ((episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC) modelConnector).getContactArea().clear();
		  	}
		}
	...
	public void finishNewSimStep(){
		...
		modelConnector.setZ(newCellLocation.getZ());
  	 	...
  	 	if(modelConnector instanceof episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC){
  	 		episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC mc = (episim_mcc_init.centerbased3d.fisheye.EpisimFishEyeCenterBased3DMC) modelConnector;
