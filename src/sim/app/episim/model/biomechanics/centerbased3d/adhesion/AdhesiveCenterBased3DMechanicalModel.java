...
import episimbiomechanics.centerbased3d.adhesion.EpisimAdhesiveCenterBased3DMC;
...
public class AdhesiveCenterBased3DMechanicalModel extends AbstractMechanical3DModel {
   ...
   public AdhesiveCenterBased3DMechanicalModel(AbstractCell cell){
   	super(cell);
   	...
   	if(ModelController.getInstance().getEpisimBioMechanicalModelGlobalParameters() instanceof AdhesiveCenterBased3DMechanicalModelGP){
   		globalParameters = (AdhesiveCenterBased3DMechanicalModelGP) ModelController.getInstance().getEpisimBioMechanicalModelGlobalParameters();
   	}
      ...
      if(cell != null && cell.getMotherCell() != null && cell.getMotherCell().getEpisimBioMechanicalModelObject() != null){
      	...
      	motherCellWidth= ((AdhesiveCenterBased3DMechanicalModel)(cell.getMotherCell().getEpisimBioMechanicalModelObject())).getKeratinoWidth();
      	
      	 if(cell.getMotherCell().getEpisimBioMechanicalModelObject() instanceof AdhesiveCenterBased3DMechanicalModel){
 	      	EpisimModelConnector motherCellConnector =((AdhesiveCenterBased3DMechanicalModel) cell.getMotherCell().getEpisimBioMechanicalModelObject()).getEpisimModelConnector();
   ...
   public HitResult hitsOther(Bag neighbours, Double3D thisloc, boolean finalPosition)
   {
       ...
       for(int i=0;i<neighbours.numObjs;i++)
       {
          ...
          if (other != getCell())
          {
         	 AdhesiveCenterBased3DMechanicalModel mechModelOther = (AdhesiveCenterBased3DMechanicalModel) other.getEpisimBioMechanicalModelObject();
   ...
   public GenericBag<AbstractCell> getDirectNeighbours(){
   	...
   	for(int i=0;neighbours != null && i<neighbours.size();i++)
      {
       ...
       {
  			AdhesiveCenterBased3DMechanicalModel mechModelOther = (AdhesiveCenterBased3DMechanicalModel) actNeighbour.getEpisimBioMechanicalModelObject();
