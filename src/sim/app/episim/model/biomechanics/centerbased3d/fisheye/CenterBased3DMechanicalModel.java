...
public class CenterBased3DMechanicalModel extends AbstractCenterBasedMechanical3DModel{
   ...
   private void setInnerEyeRadius(AbstractCell cell){
   	((CenterBased3DMechanicalModelGP)ModelController.getInstance().getEpisimBioMechanicalModelGlobalParameters()).setInnerEyeRadius(
   			((CenterBased3DMechanicalModel)cell.getEpisimBioMechanicalModelObject()).modelConnector.getInnerEyeRadius());
   }
