 ...
 * 
 * This is a copy of the Class Console, all JFrame related aspects of the original class
 * were changed into JPanel to be able to be used in the headless mode of the Simulator
 *
 */
public class NoGUIConsole extends JPanel implements SimulationConsole{
	...
	JScrollPane episimTextOutInspectorScrollPane;
		 ...
		 //   JLabel prioritySliderText;
		    ...
		    public NoGUIConsole(final GUIState simulation)
		        {
		        ...
		        if (Display2DHack.isMacOSX()) buttonBox.add(new JLabel("    "));  // move away from the scroll box
		...
		///////// Create the Save as Defaults buttons
		        ...
		        addComponentListener(new ComponentAdapter()
		            ...
		            public void componentResized(ComponentEvent e)
		                {
		                Utilities.doEnsuredRepaint(NoGUIConsole.this);
		        ...
		        this.setSize(DEFAULT_WIDTH, DEFAULT_HEIGHT);  // my default height
		     ...
		     // Fire up the simulation displays.
		        ...
		        invokeInSwing(new Runnable() { public void run() { try { simulation.init(NoGUIConsole.this); } catch (Exception e) { e.printStackTrace(); } } });
...
//		            prioritySlider.setValue(appPrefs.getInt(THREAD_PRIORITY_KEY, systemPrefs.getInt(THREAD_PRIORITY_KEY, prioritySlider.getValue())));
		    ...
		    */
		    ...
		    public static void main(String[] args)
		        ...
		        sacrificial = Display2DHack.isMacOSX();  // sacrificial  -- something to force Display2D.class to load
		    ...
		    static boolean doNew(JPanel originalPanel, boolean startingUp)
		        {
		        ...
		        while(true)
		            ...
		            try
		                ...
		                NoGUIConsole c = new NoGUIConsole(state);
		                c.setVisible(true);
		    ...
		    synchronized void showAllFrames()
		        {
		    ...
		    synchronized void hideAllFrames()
		        {
		        Object[] vals = (Object[]) (frameList.toArray());
		        for (int x = 0; x < vals.length; x++)
		            {
