...
public class XmlUniversalCell extends XmlObject<UniversalCell> {
	...
	public XmlUniversalCell(Object cell) {
		...
		episimBiomechanicalModel = new XmlEpisimBiomechanicalModel(
				uniCell.getEpisimBioMechanicalModelObject());
		episimCellBehavioralModel = new XmlEpisimCellBehavioralModel(
				uniCell.getEpisimCellBehavioralModelObject());
	}
	...
	public Node toXMLNode(String nodeName, XmlFile xmlFile) {
		...
		cellNode.appendChild(episimBiomechanicalModel.toXMLNode(
				"episimBiomechanicalModel", xmlFile));
		cellNode.appendChild(episimCellBehavioralModel.toXMLNode(
				"episimCellBehavioralModel", xmlFile));
		return cellNode;
	}
