...
public class CellEllipse {
      ...
      public void clipAreaFromEllipse(Area area){ this.clippedEllipse.subtract(area); }
      ...
      //-------------------------------------------------------------------------------------------------------
		public class Nucleus{
			...
			private double areaN;
			private double solidityN;
			private double distanceToBLN;
			...
			public Nucleus(int id, int x, int y, int majorAxis, int minorAxis, int height, int width, int orientationInDegrees, double area, double solidity, double distanceToBL, Color c){
				...
				this.colorN = c;
				this.areaN = area;
				this.solidityN = solidity;
				this.distanceToBLN = distanceToBL;
				this.rotateCellEllipseInDegrees(orientationInDegrees);
			}
	      ...
	      public void clipAreaFromEllipse(Area area){ this.clippedEllipseN.subtract(area); }
	      
	      public Shape getClippedEllipse(){ return this.clippedEllipseN; }
	     		
			public int getId() { return idN; }
			...
			public double getOrientationInRadians(){ return orientationInRadiansN; }
	      
	      public double getOrientationInDegrees(){ return this.orientationInRadiansN*(180/Math.PI); }
			
         public int getHeightExp(){ return heightExpN; }
			
         public void setHeightExp(int heightExp) { this.heightExpN = heightExp; }
		
         public int getWidthExp() { return widthExpN; }
			
         public void setWidthExp(int widthExp) { this.widthExpN = widthExp; }
			
         public Color getColorN() { return colorN; }
			
         public void setColorN(Color color) { this.colorN = color; }

			
         public double getAreaN() { return areaN; }
			
         public void setAreaN(double areaN) { this.areaN = areaN; }
			
         public double getSolidityN() { return solidityN; }
			
         public void setSolidityN(double solidityN) { this.solidityN = solidityN; }
			
         public double getDistanceToBLN() { return distanceToBLN; }
         
         public void setDistanceToBLN(double distanceToBLN) { this.distanceToBLN = distanceToBLN;}
