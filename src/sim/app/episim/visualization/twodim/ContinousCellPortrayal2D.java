...
public class ContinousCellPortrayal2D extends SimplePortrayal2D implements EpisimPortrayal
{
    ...
    {      
            ...
            {                
                ...
                if(ModelController.getInstance().getEpisimBioMechanicalModelGlobalParameters() instanceof sim.app.episim.model.biomechanics.centerbased2Df.oldmodel.CenterBased2DModelGP){
               	 drawCellEllipses = ((sim.app.episim.model.biomechanics.centerbased2Df.oldmodel.CenterBased2DModelGP)ModelController.getInstance().getEpisimBioMechanicalModelGlobalParameters()).isDrawCellsAsEllipses();
                ...
                else if(ModelController.getInstance().getEpisimBioMechanicalModelGlobalParameters() instanceof sim.app.episim.model.biomechanics.centerbased2Df.newmodel.CenterBased2DModelGP){
               	 drawCellEllipses = ((sim.app.episim.model.biomechanics.centerbased2Df.newmodel.CenterBased2DModelGP)ModelController.getInstance().getEpisimBioMechanicalModelGlobalParameters()).isDrawCellsAsEllipses();
               	 centerBasedModel = true;
                }
                drawFrame=true;
   ...
   private double getScaleFactorOfTheDisplay(){
	...
	private void doCenterBasedModelEllipseDrawing(Graphics2D graphics, DrawInfo2D info, UniversalCell universalCell, boolean showNucleus){
		if(universalCell.getEpisimBioMechanicalModelObject() instanceof sim.app.episim.model.biomechanics.centerbased2Df.oldmodel.CenterBased2DModel
				|| universalCell.getEpisimBioMechanicalModelObject() instanceof sim.app.episim.model.biomechanics.centerbased2Df.newmodel.CenterBased2DModel
				|| universalCell.getEpisimBioMechanicalModelObject() instanceof AdhesiveCenterBased2DModel){
		    AbstractBiomechanical2DModel mechModel = (AbstractBiomechanical2DModel)universalCell.getEpisimBioMechanicalModelObject();
		    CellEllipse cellEllipseObject = null;
		    if(universalCell.getEpisimBioMechanicalModelObject() instanceof sim.app.episim.model.biomechanics.centerbased2Df.oldmodel.CenterBased2DModel){
				((sim.app.episim.model.biomechanics.centerbased2Df.oldmodel.CenterBased2DModel) universalCell.getEpisimBioMechanicalModelObject()).calculateClippedCell(SimStateServer.getInstance().getSimStepNumber());
					cellEllipseObject = ((sim.app.episim.model.biomechanics.centerbased2Df.oldmodel.CenterBased2DModel) universalCell.getEpisimBioMechanicalModelObject()).getCellEllipseObject();
		    }
		    if(universalCell.getEpisimBioMechanicalModelObject() instanceof sim.app.episim.model.biomechanics.centerbased2Df.newmodel.CenterBased2DModel){
					((sim.app.episim.model.biomechanics.centerbased2Df.newmodel.CenterBased2DModel) universalCell.getEpisimBioMechanicalModelObject()).calculateClippedCell(SimStateServer.getInstance().getSimStepNumber());
					cellEllipseObject = ((sim.app.episim.model.biomechanics.centerbased2Df.newmodel.CenterBased2DModel) universalCell.getEpisimBioMechanicalModelObject()).getCellEllipseObject();
			 }
